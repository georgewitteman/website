...
ssh -o "IdentitiesOnly=yes" -i "${tmp_key_file}" ec2-user@54.71.97.150 rm -rf /home/ec2-user/website
ssh -o "IdentitiesOnly=yes" -i "${tmp_key_file}" ec2-user@54.71.97.150 mkdir -p /home/ec2-user/website
scp -o "IdentitiesOnly=yes" -i "${tmp_key_file}" -r "$tmp_dir/." ec2-user@54.71.97.150:/home/ec2-user/website
ssh -o "IdentitiesOnly=yes" -i "${tmp_key_file}" ec2-user@54.71.97.150 /home/ec2-user/website/scripts/deploy.sh
